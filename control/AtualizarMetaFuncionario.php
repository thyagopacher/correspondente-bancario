<?php
    ...
    $res = $meta->atualizar();
    if($res === FALSE){
        $msg_retorno = "Erro ao atualizar meta! Causado por:". mysqli_error($conexao->conexao);
        mail("thyago.pacher@gmail.com", "Erro sistema de condominios - control/AtualizarMetaFuncionario.php", $msg_retorno);   
        $sit_retorno = false;
    }else{
        $msg_retorno = "Meta Funcionario atualizada com sucesso!";
        $sit_retorno = true;  
