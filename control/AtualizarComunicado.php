<?php
    ...
    $res = $comunicado->atualizar();
    if($res === FALSE){
        $msg_retorno = "Erro ao atualizar comunicado! Causado por:". mysqli_error($conexao->conexao);
        mail("thyago.pacher@gmail.com", "Erro sistema de condominios - control/AtualizarComunicado.php", $msg_retorno);   
        $sit_retorno = false;
    }else{
        $msg_retorno = "Comunicado atualizado com sucesso!";
        $sit_retorno = true;        
    }
