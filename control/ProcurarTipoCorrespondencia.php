<?php
    ...
    include "../model/TipoCorrespondencia.php";
    
    $conexao = new Conexao();
    $tipo    = new TipoCorrespondencia($conexao);
    ...
    if($qtd > 0){
        ...
        while($tipo = $conexao->resultadoArray($res)){
            ...
            echo '<a href="#" onclick="excluirTipo2(',$tipo["codtipo"],')" title="Clique aqui para excluir"><img src="../visao/recursos/img/excluir.png" alt="botão excluir"/></a>';
            echo '</td>';
            echo '</tr>';
        }
        echo '</tbody>';
