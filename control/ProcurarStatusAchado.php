<?php
    ...
    if($qtd > 0){
        ...
        while($status = $conexao->resultadoArray($res)){
            ...
            echo '<td>';
            echo '<a href="javascript:setaEditar(',$arrayJavascript,')" title="Clique aqui para editar"><img src="../visao/recursos/img/editar.png" alt="botão editar"/></a>';
            echo '<a href="#" onclick="excluir(',$status["codstatus"],')" title="Clique aqui para excluir"><img src="../visao/recursos/img/excluir.png" alt="botão excluir"/></a>';
            echo '</td>';
            echo '</tr>';
        }
        echo '</tbody>';
