<?php
    ...
    $res = $manual->excluir();
    if($res === FALSE){
        $msg_retorno = "Erro ao excluir manual! Causado por:". mysqli_error($conexao->conexao);
        mail("thyago.pacher@gmail.com", "Erro sistema - control/AtualizarManual.php", $msg_retorno);   
        $sit_retorno = false;
    }else{
        $msg_retorno = "Manual excluido com sucesso!";
        $sit_retorno = true;        
    }
