...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div id="tabs">
                        ...
                        <div id="tabs-1"><?php include "./formAndamentoEsteira.php";?></div>                    
        ...
        <script src="../visao/recursos/js/ajax/AndamentoEsteira.js"></script>
        <script src="../visao/recursos/js/ajax/Proposta.js"></script>
    </body>
</html>
