<div class="row">
    <div class="box box-default">
        ...
        <div class="box-body">
            <div class="row">
                <form action="../control/ProcurarLogRelatorio.php" id="rLogSistema" name="rLogSistema" method="post">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <?php if($nivelp["procurar"] == 1){?>
                            <button class="btn btn-primary" onclick="procurarReceita(false)">Procurar</button>
                        <?php }?>
