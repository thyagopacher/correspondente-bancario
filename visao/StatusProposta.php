...
include "validacaoLogin.php";   
    if (isset($_GET["codstatus"])) {
        $sql    = "select status.* from statusproposta as status where codstatus = '{$_GET["codstatus"]}'";
...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div id="tabs">
                        ...
                        <div id="tabs-1">
                            <?php include("./formStatusProposta.php"); ?>
                        </div>
                        <?php if ($nivelp["procurar"] == 1) { ?>
                            <div id="tabs-2">
                                <?php include("formProcurarStatusProposta.php"); ?>
                            </div>
                        <?php } ?>                          
        ...
        <script src="../visao/recursos/js/ajax/StatusProposta.js"></script>
