<div class="row">
    <div class="box box-default">
        ...
        <div class="box-body">
            <div class="row">
                <form id="fpconsultas" name="fpconsultas" method="post" onsubmit="return false;">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <button class="btn btn-primary" onclick="procurarConsultasSouth(false)">Procurar</button>
                    </div>                                        
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12" id="listagemConsultas"></div>
            </div>            
        </div>
    </div>
    <!--/.col (right) -->
